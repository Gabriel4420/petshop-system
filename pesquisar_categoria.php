	...
	<a class="navbar-brand" href="home.php" style="margin-left: 80px;"><img src="https://gestaoclick.com.br/img/editor/controle-de-estoque1.png" width="30" height="30" class="d-inline-block align-top" alt=""> Estoques & Retiradas </a>
		...
		<div class="container" style="margin-top: 40px;">
			...
			<table class="table">
				...
				$sql = "SELECT `id`, `nomecategoria` FROM `categoria` WHERE `nomecategoria` LIKE '%$pesquisar%' ";
				...
				<tr>
					...
					<td>
						<a class="btn btn-warning btn-sm" href="editar_categoria.php?id=<?php echo $id ?>" role="button"><i class="fas fa-edit" style="size: 2px;"></i> Editar </a>|<a class="btn btn-danger btn-sm" href="_delete_categoria.php?id=<?php echo $id ?>" role="button"><i class="fas fa-trash" style="size: 2px;"></i> Excluir
							</a>
