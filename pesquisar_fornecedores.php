	...
	<a class="navbar-brand" href="home.php" style="margin-left: 80px;"><img src="https://gestaoclick.com.br/img/editor/controle-de-estoque1.png" width="30" height="30" class="d-inline-block align-top" alt=""> Estoques & Retiradas </a>
		...
		<div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
			<ul class="navbar-nav mr-auto">
				...
				<a class="btn btn-warning" href="index.php" style="color: black; margin-right: 30px; border-radius: 100px;"><strong>Sair</strong> <i class="fas fa-arrow-alt-circle-right"></i><span class="sr-only">(página atual)</span></a>
				<form class="form-inline my-2 my-lg-0"  method="get" action="pesquisar_fornecedores.php">
		...
		<div class="container" style="margin-top: 40px;">
			...
			<table class="table">
				...
				$sql = "SELECT `id_forn`, `nome_forn` FROM `fornec` WHERE `nome_forn` LIKE '%$pesquisar%' ";
				...
				<tr>
					...
					<td>
						<a class="btn btn-warning btn-sm" href="editar_fornecedores.php?id=<?php echo $id ?>" role="button"><i class="fas fa-edit" style="size: 2px;"></i> Editar </a>|<a class="btn btn-danger btn-sm" href="../backend/delete/_delete_fornecedor.php?id=<?php echo $id ?>" role="button"><i class="fas fa-trash" style="size: 2px;"></i> Excluir
							</a>
