			...
			<table class="table" style="column-span: 20px;">
				...
				while ( $array = mysqli_fetch_array($busca)) {
					...
					<tr>
						...
						<td>
							<a class="btn btn-warning btn-sm" href="editar_fornecedores.php?id=<?php echo $id ?>" role="button"><i class="fas fa-edit" style="size: 2px;"></i> Editar </a>|<a class="btn btn-danger btn-sm" href="_delete_fornecedores.php?id=<?php echo $id ?>" role="button"><i class="fas fa-trash" style="size: 2px;"></i> Excluir
							</a>
