...
<head>
	...
	<style>#tamanhoContainer{width: 500px; box-shadow: 5px; box-sizing: 3px; border: 2px;}</style>
</head>
<body>
	...
	<div class="container" style="margin-top: 40px;" id="tamanhoContainer">
		...
		<form action="_inserir_categoria.php" method="post" style="margin-top: 20px;">
			...
			<div class="form-group">
				...
				<br>
				<input type="text" class="form-control" name="nomecategoria" placeholder="Insira o nome da categoria" style="border-radius: 120px;" required>
				<br>
			</div>
